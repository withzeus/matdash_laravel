<aside id="mainSidebar"
  ...
  <nav class="flex-1 overflow-y-auto p-4 space-y-6" data-simplebar>
    <div>
      <p class="px-3 text-xxs font-bold text-gray-400 uppercase tracking-wider mb-2 text-[10px]">Dashboards</p>
      <ul class="space-y-1">
        <li>
          <a href="javascript:void(0)" class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-xl transition-colors {{ (request()->is('/') || request()->is('dashboard*')) ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
